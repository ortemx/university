...
namespace WindowsFormsApp1
{
    public partial class Form1 : Form
    {
        ...
        private void DrawGraphic()
        {
            ...
            graphics.DrawString("0", SystemFonts.DefaultFont, new SolidBrush(Color.Black), x_screen(0) + 3, y_screen(0) - 15); //рисует начало координат 0
            graphics.DrawString("Y", SystemFonts.DefaultFont, new SolidBrush(Color.Black), x_screen(0) - 15, y_screen(y1) + 3);  //рисует название оси у
            graphics.DrawString("X", SystemFonts.DefaultFont, new SolidBrush(Color.Black), x_screen(x2) - 10, y_screen(0) - 15); //рисует название оси х
