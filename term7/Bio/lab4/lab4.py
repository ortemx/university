...
PEOPLE: List[str] = ["Michael", "Sarah", "Joshua", "Narine", "David", "Sajid", "Melanie", "Daniel", "Wei", "Dean", "Bri-an", "Murat", "Lisa"] # 165 bytes compressed
...
if __name__ == "__main__":
    ...
    ga: GeneticAlgorithm[ListCompression] = GeneticAlgorithm(initial_population=initial_population, threshold=1.0, max_generations = 500, mutation_chance = 0.2, crossover_chance = 0.7, selec-tion_type=GeneticAlgorithm.SelectionType.TOURNAMENT)
